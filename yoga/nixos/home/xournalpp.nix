...
<settings>
  ...
  <property name="minimumPressure" value="0.01"/>
  <property name="pressureMultiplier" value="1.32"/>
  <property name="zoomGesturesEnabled" value="false"/>
  <property name="selectedToolbar" value="custom"/>
  <property name="lastSavePath" value="/home/aktire/Documents/Studienkolleg_materials"/>
  <property name="lastOpenPath" value=""/>
  <property name="lastImagePath" value="/home/aktire/Pictures"/>
  ...
  <property name="mainWndWidth" value="1390"/>
  <property name="mainWndHeight" value="1060"/>
  ...
  <property name="emptyLastPageAppend" value="onDrawOfLastPage"/>
  ...
  <property name="fullscreenViewModeAttributes" value="goFullscren,showToolbar"/>
  ...
  <property name="scrollbarHideType" value="both"/>
  ...
  <property name="addVerticalSpace" value="true"/>
  <property name="addVerticalSpaceAmountAbove" value="67"/>
  <property name="addVerticalSpaceAmountBelow" value="67"/>
  ...
  <property name="snapRotation" value="false"/>
  ...
  <property name="selectionBorderColor" value="4288321942"/>
  <property name="backgroundColor" value="4278190080"/>
  <property name="selectionMarkerColor" value="4284653802"/>
  <property name="activeSelectionColor" value="4281697508"/>
  ...
  <property name="strokeFilterIgnoreTime" value="500"/>
  ...
  <property name="trySelectOnStrokeFiltered" value="true"/>
  <property name="snapRecognizedShapesEnabled" value="false"/>
  <property name="restoreLineWidthEnabled" value="true"/>
  <property name="numIgnoredStylusEvents" value="0"/>
  <property name="inputSystemTPCButton" value="false"/>
  <property name="inputSystemDrawOutsideWindow" value="false"/>
  ...
  <property name="stabilizerAveragingMethod" value="2"/>
  ...
  <property name="colorPalette" value="/app/share/xournalpp/palettes/xournal.gpl"/>
  <property name="latexSettings.autoCheckDependencies" value="true"/>
  <property name="latexSettings.defaultText" value="x^2"/>
  <property name="latexSettings.globalTemplatePath" value="/app/share/xournalpp/resources/default_template.tex"/>
  ...
  <data name="buttonConfig">
    ...
    <data name="middle">
      <attribute name="tool" type="string" value="selectRegion"/>
    </data>
    <data name="right">
  ...
  <data name="tools">
    ...
    <data name="highlighter">
      <attribute name="color" type="hex" value="ffff7800"/>
    ...
    <data name="laserPointerHighlighter">
      <attribute name="color" type="hex" value="ffff8000"/>
      <attribute name="size" type="string" value="MEDIUM"/>
    </data>
    ...
    <data name="pen">
      ...
      <attribute name="drawingType" type="string" value="default"/>
      <attribute name="fill" type="int" value="0"/>
      <attribute name="fillAlpha" type="int" value="13"/>
      <attribute name="size" type="string" value="MEDIUM"/>
    ...
    <data name="text">
      <attribute name="color" type="hex" value="ff008000"/>
    </data>
...
[custom]
toolbarBottom1=SAVE,SEPARATOR,UNDO,REDO,SEPARATOR,PLAIN,DASHED,TOOL_FILL,FILL_OPACITY,ERASER,HIGHLIGHTER,LASER_POINTER,SELECT_PDF_TEXT_LINEAR,TEXT,IMAGE,SHAPE_RECOGNIZER,GRID_SNAPPING,RULER,DRAW_ARROW,DRAW_COORDINATE_SYSTEM,DRAW_RECTANGLE,DRAW_ELLIPSE,SEPARATOR,COLOR_SELECT,COLOR(0),COLOR(1),COLOR(6),COLOR(4),SEPARATOR,FINE,MEDIUM,THICK,SEPARATOR,SELECT_RECTANGLE,COPY,PASTE,VERTICAL_SPACE,SPACER,GOTO_BACK,GOTO_NEXT,ZOOM_100,ZOOM_FIT
name=Comfy
'';
}
